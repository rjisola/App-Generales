...
# Asume que el archivo Excel estará en el mismo directorio o en 'datos/'
EXCEL_FILE_PATH = os.path.join(os.path.dirname(__file__), 'Datos', '2-VALOR_HORAS_SUELDOS.xlsx')
...
def calculate_uecara(data):
    ...
    results = {
        ...
        "total_deducciones": _format_currency_decimal(total_deducciones),
