Sub generarHorasMarron(fila, columna, Dia, ByRef presentismo, feriado, ByRef horas)

    'BLANCO:
    'de lunes a viernes: 8 hs normales, >8 al 50%  - lunes a jueves 9 > al 50% > 12 al 100% normales viernes 8 normales > al 50% > 12 al 100%
    'sabados: 4hs normales, >4 1 al 50% y el resto al 100% - sabado 4 al 50% el resto al 100%
    ...
    'No le suman las horas normales
    ...
    Else
        If Dia = "lunes" Or Dia = "martes" Or Dia = "miércoles" Or Dia = "jueves" Then
            ...
            If horas > 9 And horas <= 12 Then
                horasNormales = horas
                
            End If
           If horas > 12 And horas <= 24 Then
                horasNormales = horas
