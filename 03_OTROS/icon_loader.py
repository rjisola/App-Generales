...
class IconLoader:
    ...
    def __init__(self, icons_dir="app_icons"):
        ...
        """
        # Obtener directorio del motor de iconos (03_OTROS/)
        motor_dir = os.path.dirname(os.path.abspath(__file__))
        # Raíz del proyecto
        project_root = os.path.dirname(motor_dir)
        # Ruta centralizada de iconos en 02_CARPETAS
        self.icons_dir = os.path.join(project_root, "02_CARPETAS", icons_dir)
        self.icons = {}
        self._loaded = False
    ...
    def load_icon(self, icon_name, size=(64, 64)):
        ...
        if not os.path.exists(icon_path):
            print(f"[ADVERTENCIA] Icono no encontrado: {icon_path}")
            return None
