Sub completarImprimirGris(fila, contador, columna, desplazamiento, color)
    ...
    End If
    'Total quincena
    totalQuincena = sueldoAcordado + totalExtras + premio + reintegro + ajusteAlquiler + importeFeriado + adelanto
    ...
    Hoja1.Cells(contador + 8, columna).Value = "TOTAL EXTRAS"
    Hoja1.Cells(contador + 8, columna + 1).Value = totalExtras
