Function unificarDatosCeleste(fila, columna, Dia) As Single
    ...
    If horas = "LLUVIA" Or horas = "lluvia" Then
        unificarDatosCeleste = 2.5
    Else
        If horas = "CORTARON" Or horas = "cortaron" Then
            unificarDatosCeleste = 0
        Else
            
            'Si VACACIONES o NO o AVISO
            If horas = "NO" Or horas = "VAC" Or horas = "VACACIONES" Or horas = "c/aviso" Or horas = "C/AVISO" Or horas = "C/A" Or horas = "c/a" Or horas = "ART" Or horas = "CORTADO" Or horas = "SIN HORAS" Then
                unificarDatosCeleste = 0
            Else
