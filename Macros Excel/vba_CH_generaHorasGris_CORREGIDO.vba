Sub generarHorasGris(fila, columna, Dia, ByRef presentismo, feriado, ByRef horas)
    ...
    'IMPORTANTE: Las horas normales NO se acumulan porque están incluidas en el sueldo acordado
    ...
    Else
        If Dia = "lunes" Or Dia = "martes" Or Dia = "miércoles" Or Dia = "jueves" Then
            ...
            ' MODIFICADO: Solo acumular horas extras (>9), no las normales
            If horas > 9 Then
                horasAlCincuenta = horas - 9
            End If
        ...
        If Dia = "viernes" Then
            ...
            ' MODIFICADO: Solo acumular horas extras (>8), no las normales
            If horas > 8 Then
                horasAlCincuenta = horas - 8
            End If
    ...
    ' MODIFICADO: NO acumular horas normales (línea comentada)
