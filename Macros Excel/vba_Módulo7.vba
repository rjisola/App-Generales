...
'
    ...
    With ws
        ...
        With .Sort
            ...
            ' OJO: El rango "A1:AF62" es fijo. Si tus datos crecen más allá de la fila 62,
            ' esta parte podría necesitar un ajuste para ser dinámica.
            lastRow = ws.Cells(ws.Rows.Count, "A").End(xlUp).Row
            .SetRange ws.Range("A1:AF100")
            .Header = xlYes
            .MatchCase = False
